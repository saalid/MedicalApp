...
<head>
  ...
  <title>MedicalApp - @yield('title')</title>
  ...
  <!-- persian Date Picker -->
  <link rel="stylesheet" href="{{ asset('assets/dist/css/persian-datepicker-0.4.5.min') }}">
  <!-- Font Awesome -->
...
<div class="wrapper">
                  ...
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-right">
                        <img src="assets/{{ asset('assets/dist/img/user2-160x160.jpg') }}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        امیررضا
  ...
  <footer class="main-footer text-left"> 
    <strong>MedicalApp &copy; 2021-2022 Version 1.0.0 <a href="#">Amirreza Salari</a></strong>
  </footer>
